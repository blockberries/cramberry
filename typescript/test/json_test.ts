...
export function encodePerson(writer: Writer, msg: Person): void {
  ...
  // Field 3: address
  writer.writeTag(3, WireType.Bytes);
  { const __cp = writer.beginMessage(); encodeAddress(writer, msg.address); writer.endMessage(__cp); };
