...
LDFLAGS := -X github.com/blockberries/cramberry/v2/pkg/cramberry.Version=$(VERSION) \
           -X github.com/blockberries/cramberry/v2/pkg/cramberry.GitCommit=$(COMMIT) \
           -X github.com/blockberries/cramberry/v2/pkg/cramberry.BuildDate=$(BUILD_DATE)
